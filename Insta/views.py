# View get all the requests, and decide to use which model and template
...
class PostsView(ListView):
    ...
    #Default get_queryset will get all the post, overwrite it so that it only get follower's post
